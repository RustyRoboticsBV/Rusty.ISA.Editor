...
public class Ledger
{
    ...
    public LanguageDropdown Languages { get; private set; }
    ...
    /* Constructors. */
    public Ledger(InstructionSet set, GraphEdit graphEdit, InspectorWindow inspectorWindow, LanguageDropdown languages)
    {
        Set = set;
        GraphEdit = graphEdit;
